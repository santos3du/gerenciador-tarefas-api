...
--INSERT INTO tb_tarefa(titulo, descricao, prazo, departamento_id, duracao, pessoa_id, situacao) VALUES ('Bug 352', 'Corrigir bug 352 na versão 1.25', TIMESTAMP WITH TIME ZONE '2022-05-10T13:00:00Z', 3, 25, 1, 0);
--INSERT INTO tb_tarefa(titulo, descricao, prazo, departamento_id, duracao, pessoa_id, situacao) VALUES ('Liberação da versão 1.24', 'Disponibilizar pacote para testes', TIMESTAMP WITH TIME ZONE '2022-02-22T:00:45:10Z',3, 2, 1, 0);
...
--INSERT INTO tb_tarefa(titulo, descricao, prazo, departamento_id, duracao, pessoa_id, situacao) VALUES ('Reunião final', 'Fechamento contrato', TIMESTAMP WITH TIME ZONE '2022-03-28T10:30:00Z', 2, 2, 6, 0);
...
--INSERT INTO tb_tarefa(titulo, descricao, prazo, departamento_id, duracao, pessoa_id, situacao) VALUES ('Validar NF Fevereiro', 'Validar notas recebidas no mês de fevereiro', TIMESTAMP WITH TIME ZONE '2022-03-15T09:20:00Z', 1, 14, 1, 0);